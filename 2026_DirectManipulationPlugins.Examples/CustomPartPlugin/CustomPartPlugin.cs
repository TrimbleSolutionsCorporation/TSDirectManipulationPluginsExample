...
namespace CustomPartPlugin
{
    ...
    /// </summary>
    [Plugin(PluginName)] // Mandatory field which defines that the class is a plug-in-and stores the name of the plug-in to the system.
    [PluginUserInterface("CustomPartPlugin.CustomPartPluginForm")] // Mandatory field which defines the user interface the plug-in uses. A windows form class of a .inp file.
    public class CustomPartPlugin : CustomPartBase
    {
        ...
        /// </summary>
        public const string PluginName = "CustomPart DM Plugin Example";

        public const string DefaultProfileName = "HEA300";

        // The constructor argument defines the database class StructuresData and set the data to be used in the plug-in.
        public CustomPartPlugin(StructuresData data)
        {
            this.Data = data;
        }
